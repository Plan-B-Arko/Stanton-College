       ...
       <li class="treeview {{($prefix == '/users' )  ? 'active' : ''}} ">
        ...
        <li class="treeview {{($prefix == '/employees' )  ? 'active' : ''}} ">
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ ($route == 'employee.leave.view' )  ? 'active' : '' }}"><a href="{{ route('employee.leave.view') }}"><i class="ti-more"></i>Employee Leave View</a></li>
        ...
        <li class="treeview {{($prefix == '/accounts' )  ? 'active' : ''}} ">
          ...
          <a href="#">
            <i data-feather="grid"></i> <span>Accounts Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview {{($prefix == '/reports' )  ? 'active' : ''}} ">
            ...
            <a href="#">
              <i data-feather="grid"></i> <span>Reports Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
            </a>
