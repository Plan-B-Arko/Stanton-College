            ...
            <li class="treeview {{ $prefix == '/setups' ? 'active' : '' }} ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'student.semester.view' ? 'active' : '' }}"><a
                            href="{{ route('student.semester.view') }}"><i class="ti-more"></i>Student Semester</a></li>
            ...
            <li class="treeview {{ $prefix == '/students' ? 'active' : '' }} ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'roll.generate.view' ? 'active' : '' }}"><a
                            href="{{ route('roll.generate.view') }}"><i class="ti-more"></i>Roll Generate</a></li>
            ...
            <li class="treeview {{ $prefix == '/employees' ? 'active' : '' }} ">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ $route == 'employee.attendance.view' ? 'active' : '' }}"><a
                            href="{{ route('employee.attendance.view') }}"><i class="ti-more"></i>Employee Attendance
                        </a></li>
