                                            ...
                                            <div class="row"> <!-- 1st Row -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="grade_name"
                                                                value="{{ $editData->grade_name }}" class="form-control"
                                                                required="">
                                                        </div>
                                                    </div>
                                                </div> <!-- End Col md 4 -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="grade_point"
                                                                value="{{ $editData->grade_point }}" class="form-control"
                                                                required="">
                                                        </div>
                                                    </div>
                                                </div> <!-- End Col md 4 -->
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text"
                                                                name="start_marks"value="{{ $editData->start_marks }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="end_marks"
                                                                value="{{ $editData->end_marks }}"class="form-control"
                                                                required="">
                                                        </div>
                                                    </div>
                                                </div> <!-- End Col md 4 -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="start_point"
                                                                value="{{ $editData->start_point }}"class="form-control"
                                                                required="">
                                                        </div>
                                                    </div>
                                                </div> <!-- End Col md 4 -->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="end_point"
                                                                value="{{ $editData->end_point }}"class="form-control"
                                                                required="">
                                                        </div>
                                                    </div>
                                                </div> <!-- End Col md 4 -->
                                            ...
                                            <div class="row"> <!-- 3rd Row -->
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text"
                                                                name="remarks"value="{{ $editData->remarks }}"
                                                                class="form-control" required="">
                                                        </div>
                                                    </div>
                                                </div><!-- End Col md 4 -->
